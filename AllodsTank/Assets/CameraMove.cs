...
public class CameraMove : MonoBehaviour
{
    ...
    [SerializeField] private float _maxRadius = 5f; // Максимальный радиус от _target
    ...
    private void FollowMouseWithLimit()
    {
        ...
        mousePosition.z = -Camera.main.transform.position.z; // Глубина проекции в мир
        ...
        // Ограничиваем движение камеры радиусом
        ...
        // Перемещаем камеру с плавным замедлением
        transform.position = Vector3.SmoothDamp(transform.position, targetPosition, ref _velocity, _damping);
    }
}